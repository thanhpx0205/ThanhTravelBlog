                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr class="addfont">
                                        <th>STT</th>
                                        <th style="width: 500px" >Tên Blog</th>
                                        <th>Tài khoản</th>
                                        <th>Nội dung</th>
                                        <th></th>
                                        <th></th>
                                ...
                                ?>
                                    <tr class="addfont">
                                        ...
                                        <td>
                                          <?php 
                                            foreach (selectAll("SELECT * FROM blog WHERE id={$row['id_blog']}") as $item) {
                                            echo $item['ten'];
                                          }
                                          ?>
                                        </td>
                                        ...
                                        <td></td>
                                        <td>
                                        <a type="button" class="btn btn-primary btn-icon-text" href="../detail.php?id=<?= $row['id_blog']?>#contact-tab">
